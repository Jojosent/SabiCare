...
class AddChildFragment : Fragment() {
    ...
    private fun saveChild() {
        ...
        if (isOnboarding) {
            // Tell OnboardingActivity to go to MainActivity
    ...
    private fun prefillForEdit() {
        // Will be filled when user taps edit from ProfileFragment
        // ChildViewModel will provide child data
